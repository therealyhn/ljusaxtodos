...
export default function AboutCard({ name, location, bio, specialties, socials, gradient }) {
  return (
    <div className="bg-background rounded-xl shadow-lg p-6 flex flex-col items-center text-center gap-4 
    hover:shadow-primary-blue/60 transition border border-gray-800 relative">
      {/* Avatar placeholder */}
      <div
